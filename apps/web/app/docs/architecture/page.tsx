...
AgentFence Daemon
      ...
      <ul>
        ...
        <li>`crates/agentfence-cli`: shell checks, guarded execution, MCP proxies, integration profiles, bundles, audits, and approvals.</li>
        <li>`crates/agentfence-daemon`: local HTTP API for policy, approvals, audit, filesystem, network, skill, MCP, and simulation checks.</li>
